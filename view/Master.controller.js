sap.ui.core.mvc.Controller.extend("EquipmentHistory.view.Master", {
	...
	onRouteMatched: function(oEvent) {
		...
		this.getRouter().myNavToWithoutHash({
			...
			targetViewName: "EquipmentHistory.view.Master2",
			targetViewType: "XML"
		});
		...
		this.getRouter().myNavToWithoutHash({
			currentView: this.getView(),
			targetViewName: "EquipmentHistory.view.Welcome",
			targetViewType: "XML"
		});
	},
	...
	onSearch: function() {
		...
		if (searchString && searchString.length > 0) {
			filters = [new sap.ui.model.Filter("EQUNR", sap.ui.model.FilterOperator.Contains, searchString)];
		}
