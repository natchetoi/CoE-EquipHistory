sap.ui.core.mvc.Controller.extend("EquipmentHistory.view.Master2", {
	...
	onRoutePatternMatched: function(oEvent) {
		...
		this.getRouter().myNavToWithoutHash({
			...
			targetViewName: "EquipmentHistory.view.Detail",
			targetViewType: "XML",
			transition: "slide"
		});
	},
	...
	showEmptyView: function() {
		this.getRouter().myNavToWithoutHash({
			currentView: this.getView(),
			targetViewName: "EquipmentHistory.view.NotFound",
			targetViewType: "XML"
		});
	},
	...
	onSearch: function() {
		...
		if (searchString && searchString.length > 0) {
			filters = [new sap.ui.model.Filter("QMDAT", sap.ui.model.FilterOperator.Contains, searchString)];
		}
